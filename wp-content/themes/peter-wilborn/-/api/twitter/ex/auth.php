...
// already got some credentials stored?
  ...
  if ($code == 200) {
    ...
    echo '<code>';
    echo 'Consumer Key: '.$tmhOAuth->config['consumer_key'].'<br />';
    echo 'Consumer Secret: '.$tmhOAuth->config['consumer_secret'].'<br />';
    echo 'User Token: '.$tmhOAuth->config['user_token'].'<br />';
    echo 'User Secret: '.$tmhOAuth->config['user_secret'].'<br />';
    echo '</code>';
    die();
